export class GlobalConstants {
  ...
  public static currentUserPath = this.apiBasePath + this.authorizationServicePath + '/current/notification';
  public static notificationUserPath = this.apiBasePath + this.authorizationServicePath + '/current/notification';
