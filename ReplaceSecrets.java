...
public class ReplaceSecrets {
	private static final String RUTA_ARCHIVO = "src/app/app.module.ts";
	...
	public static void main(String[] args) {
		try {
			if (args.length == 2) {
				...
				File myObj = new File(RUTA_ARCHIVO);
				if (myObj.createNewFile()) {
					System.out.println("Cargando");
					fileReader = new FileReader(new File(RUTA_ARCHIVO).getAbsolutePath());
				} else {
					System.out.println("Cargando");
